...
Here we summarize the status of knowledge for ESD's across the UFO field office. As our management objectives rely on these benchmarks values to determine whether our land is within the range of natural variability, they are an essential component of this.
...
png('../results/graphics/Sankey_plots.png')
...
```{r}
rm(bp_sampled, correlated, ov_sampled, plots_sampled, plots_w_ESD)
```
